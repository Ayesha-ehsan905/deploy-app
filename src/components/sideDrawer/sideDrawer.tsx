  ...
  return (
    <>
      <Box>
        ...
        <Text align={"left"} css={{ marginTop: "30px",fontSize:'22px',marginLeft:'12px' ,cursor:'pointer'}} onClick={props.drawer} >X</Text>
          ...
          <Box postion={"left"} css={{backgroundImage:'none',marginTop: "135px"}}>
            <Text align={"left"}>LOGIN</Text>
          </Box>
          
          <Button style={"Register_btn"} css={{ marginTop: "320px" }}>REGISTER</Button>
